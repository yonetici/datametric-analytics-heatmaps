...
class TestDatabase extends TestCase {
	...
	public function test_get_table_name() {
		...
		$this->assertEquals( 'wp_datametric_clicks', $table_name );
	}
	...
	public function test_log_click() {
		...
		$this->assertEquals( 'wp_datametric_clicks', $wpdb->last_insert['table'] );
	...
	public function test_mock_repository_injection() {
		...
		$mock_repo = $this->createMock( \DataMetric\Includes\Repository\EventRepository::class );
